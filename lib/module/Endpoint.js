...
export const ORIENTATIONS = ['PJMEDIA_ORIENT_UNKNOWN', 'PJMEDIA_ORIENT_ROTATE_90DEG', 'PJMEDIA_ORIENT_ROTATE_270DEG', 'PJMEDIA_ORIENT_ROTATE_180DEG', 'PJMEDIA_ORIENT_NATURAL'];
export default class Endpoint extends EventEmitter {
  constructor() {
    ...
    DeviceEventEmitter.addListener('pjSipStopped', this._onStopped.bind(this));
  }
  /**
  ...
  makeCall(account, destination, callSettings, msgData) {
    ...
    return new Promise((resolve, reject) => {
      NativeModules.PjSipModule.makeCall(account.getId(), normalizedDestination, callSettings, msgData, (successful, data) => {
        if (successful) {
  ...
  sendMessage(account, destination, msg) {
    ...
    return new Promise((resolve, reject) => {
      NativeModules.PjSipModule.sendMessage(account.getId(), normalizedDestination, msg, (successful, data) => {
        if (successful) {
          resolve(data);
        } else {
          reject(data);
  ...
  imTyping(account, destination, isTyping) {
    ...
    return new Promise((resolve, reject) => {
      NativeModules.PjSipModule.imTyping(account.getId(), normalizedDestination, isTyping, (successful, data) => {
        if (successful) {
          resolve(data);
        } else {
          reject(data);
  ...
  xferCall(account, call, destination) {
    ...
    return new Promise((resolve, reject) => {
      NativeModules.PjSipModule.xferCall(call.getId(), normalizedDestination, (successful, data) => {
        if (successful) {
          resolve(data);
        } else {
          reject(data);
  ...
  redirectCall(account, call, destination) {
    ...
    return new Promise((resolve, reject) => {
      NativeModules.PjSipModule.redirectCall(call.getId(), normalizedDestination, (successful, data) => {
        if (successful) {
          resolve(data);
        } else {
          reject(data);
